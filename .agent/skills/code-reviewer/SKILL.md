...
- Look for test coverage of .ts files. If you see strong gaps suggest improvements. However do not add unit tests for files which has explicit comments saying they should not be unit tested.
